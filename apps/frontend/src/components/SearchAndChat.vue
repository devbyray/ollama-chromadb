<template>
	<div class="py-6 flex flex-col justify-center sm:py-12">
		<div class="relative py-3 sm:max-w-xl sm:mx-auto">
			<div class="relative px-4 py-10 bg-white dark:bg-slate-500 shadow-lg sm:rounded-3xl sm:p-20">
				<div class="max-w-2xl mx-auto">
					<div class="divide-y divide-gray-200">
						<div class="py-8 text-base leading-6 space-y-4 sm:text-lg sm:leading-7">
							...
							<div class="relative">
								<label class="text-sm"> Enter your search query </label>
								<input
									type="text"
									v-model="query"
									@keyup.enter="handleSearch"
									class="peer w-full border-b-2 border-gray-300 focus:outline-none focus:border-blue-600"
