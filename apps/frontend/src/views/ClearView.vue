<template>
	<div class="mx-auto p-4 max-w-2xl w-full bg-white dark:bg-slate-500 shadow rounded-lg">
		<h1 class="text-2xl font-bold mb-4">Clear ChromaDB Collection</h1>

		<div class="bg-red-50 dark:bg-red-800 dark:text-red-50 border border-red-200 rounded p-4 mb-4">
			<p class="text-red-700 dark:text-red-50 mb-4">
